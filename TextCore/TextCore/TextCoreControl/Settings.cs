...
namespace TextCoreControl
{
    public static class Settings
    {
        static Settings()
        {
            ...
            Settings.DefaultTextFormat                     = dwriteFactory.CreateTextFormat("Consolas", 15, FontWeight.Normal, FontStyle.Normal, FontStretch.Normal);
            Settings.DefaultShowFormattingTextFormat       = dwriteFactory.CreateTextFormat("Consolas", 13, FontWeight.Normal, FontStyle.Normal, FontStretch.Normal);
