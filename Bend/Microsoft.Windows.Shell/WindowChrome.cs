...
namespace Microsoft.Windows.Shell
{
    ...
    public class WindowChrome : Freezable
    {
        ...
        public static bool FindOtherApplicationInstance(out IntPtr hWnd)
        {
        ...
        public const int MAGIC_NUMBER = 202020;
        public static void SendFileNameToHwnd(IntPtr hWnd, string file)
        {
            ...
            NativeMethods.SendMessage(hWnd, WM.COPYDATA, IntPtr.Zero, lpStruct);
        }
        ...
        public delegate void RecivedFileNameEventHandler(string fileName);
        public event RecivedFileNameEventHandler RecivedFileNameEvent;
